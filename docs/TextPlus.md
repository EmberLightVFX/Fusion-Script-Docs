# TextPlus
 : [Object](Object.md) : [Operator](Operator.md) : [ThreadedOperator](ThreadedOperator.md) : [SourceOperator](SourceOperator.md)
___
### Methods  
> [!TIP|labelVisibility:hidden|iconVisibility:hidden]
> [UpdateWordAnimation](#UpdateWordAnimation)()
>
### Registry Attributes
...
>
> ```php
boolean TextPlus:UpdateWordAnimation()
> ```
>
> ```php
 TextPlus:UpdateWordAnimation([table style table])
> ```
>
___
...
> `Type: string`
>
> C:\Program Files\Blackmagic Design\Fusion 20\Plugins\text.plugin
>
___
